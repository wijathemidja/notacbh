...
echo “n-snake is a snake game in your terminal, 2048 is 2048 (I got 4096), dolphin is a file manager and chromium lets you run extensions and sometimes get past the firewall”
